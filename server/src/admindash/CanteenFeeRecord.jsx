...
export default function CanteenFeeRecord() {
  ...
  const fetchStudentCanteenFeeDetails = async (studentId) => {
    ...
    try {
      ...
      try {
        const canteenFeeRes = await axios.get(`${API_BASE_URL}/api/canteen-fees/student/${studentId}`);
        ...
        try {
          const altRes = await axios.get(`${API_BASE_URL}/api/students/${studentId}/canteen-fees`);
  ...
  const processPayment = async () => {
    ...
    try {
      ...
      const response = await axios.put(`${API_BASE_URL}/api/canteen-fees/${selectedRecord._id}`, updatedRecord);
  ...
  const handleDeleteCanteenFeeRecord = async (recordId) => {
    ...
    try {
      await axios.delete(`${API_BASE_URL}/api/canteen-fees/${recordId}`);
  ...
  const handleUpdateCanteenFeeRecord = async (e) => {
    ...
    try {
      if (selectedRecord) {
        ...
        const response = await axios.put(`${API_BASE_URL}/api/canteen-fees/${selectedRecord._id}`, finalFormData);
        ...
        // Create new record
        const response = await axios.post(`${API_BASE_URL}/api/canteen-fees`, finalFormData);
